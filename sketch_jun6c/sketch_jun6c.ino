...
// === WIFI SETUP ===
const char* ssid = "Riil";
const char* password = "11111111";

// === MQTT TLS SETUP ===
const char* mqtt_server = "e1ba2dc5f46b4b46a15520b16e2bebc2.s1.eu.hivemq.cloud";
const int mqttPort = 8883;
const char* mqttUser = "drip_flush_iot";
const char* mqttPassword = "TeluJuara1";
...
void setup() {
  ...
  setup_wifi();
  espClient.setInsecure(); // hanya untuk test/dev
